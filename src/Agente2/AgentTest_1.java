 ...
 */
public class AgentTest_1 extends AbstractPlayer {//Agente encargado de leer la tabla Q resumida
    /**
     ...
     */
    public AgentTest_1(StateObservation so, ElapsedCpuTimer elapsedTimer)
    {
    ...
    StateObservation SOFuturoX1 = stateObs.copy();
    	...
    	int accion = TablaQ.sacarMejorResumen(ident_s);
